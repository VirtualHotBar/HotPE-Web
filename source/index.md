...
<div class="gback">
        ...
        <div class="container">
            <div class="left-box" >
            <img src="//sc.sysri.cn/i/p/1/68e90f1dc518c.png">
            </div>
            <div class="right-content">
                <h1>HotPE 工具箱</h1>
                <p>现已更新到 2.8 版本，全新 Win11 内核</p>
                <p>真正的纯净、无广告、无劫持、无后门</p>
                <p>内置主流的无线、有线、声卡、硬盘驱动</p>
                <p>拥有极高的兼容性，以及强大的模块系统</p>
            </div>
        </div>
        <!-- 页脚：版权信息 -->
        <div class="footer">
            <p>© 2019-Present VirtualHotBar</p>
        </div>
    </div>
...
<p><img src="//sc.sysri.cn/i/p/1/68e917239c006.png" /></p>
<p>正常资源占用情况，2GB左右内存也能完美使用。</p>
<br/>

<p><img src="//sc.sysri.cn/i/p/1/68e9186d06f23.png" /></p>
 ...
 .gback .left-box {
    ...
    img,.gback {
        ...
        div.gback {
            ...
            background-image: linear-gradient(125deg, #00A2E8, #597DFC, #1296DB, #B28BC2, #0080FF);
            background-size: 400%;
