...
<div style="text-align: center;">
        ...
        <p style="text-align: center">Project Web:
            ...
            <a href="https://aitier.net/" target="_blank" class="class-link"  rel="noopener" > AI天梯图</a> |
...
<div >
        <div style="border-top: 1px solid rgba(0, 0, 0, 0.1);padding: 10px 10px 10px;text-align: center;">
                ...
                <p style="margin: 8px 0 0;">
                        <a href="https://tokeness.io/" target="_blank" rel="noopener" style="display: inline-block; vertical-align: middle; margin-right: 6px;margin-top: -3px;">
                                <img src="https://tokeness.io/_static/logo.svg" alt="Tokeness.io logo" width="20" height="20" loading="eager" data-no-lazyload="true" style="display: block;">
                        </a>
                        <span>本项目的 AI Tokens 由 <a href="https://tokeness.io/" target="_blank" rel="noopener" class="class-link">Tokeness.io</a> 赞助提供</span>
                </p>
        </div>
</div>
</footer>`, 'default');
